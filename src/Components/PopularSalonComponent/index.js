...
import { popularData, upComingData } from '../../Utils/data';
...
const PopularSalonComponent = ({ props, navigation }) => {
  ...
  return (
    <View>
      ...
      {showLoader == true ? <BarIndicator color='white' count={9} size={10} animating={showLoader} /> : <View style={{ flexDirection: 'row' }}>
        <FlatList
          data={professionals}
...
export default PopularSalonComponent;
